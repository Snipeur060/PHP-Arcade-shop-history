...
$db = new Mysqli('localhost','userdb','pass','namedb');
...
$sql = "SELECT * FROM `tracking` WHERE `productname` = '$productname' AND `date` > DATE_SUB(NOW(), INTERVAL 25 DAY) ORDER BY `id` DESC";
